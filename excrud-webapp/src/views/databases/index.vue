<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Primary Key" width="110">
        <template slot-scope="{row}">
          <el-dropdown>
            <el-button type="primary" size="mini" style="background:#fff;border:solid 1px #ddd;color:black;">
              NONE<i class="el-icon-arrow-down el-icon--right" />
            </el-button>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>NONE</el-dropdown-item>
              <el-dropdown-item divided>id</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
      
        <el-table-column label="Host" width="180px">
          <template slot-scope="{row}">
            <span>127.0.0.1:3306</span><br><span>192.168.255.250:3306</span>
          </template>
        </el-table-column>
      ...
      <el-table-column label="Actions" width="200" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="exportProject('xml', row.id)">SQL File</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
