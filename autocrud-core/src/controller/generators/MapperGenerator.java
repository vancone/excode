...
import model.lang.annotations.KeyValueAnnotation;
import model.lang.annotations.ParentAnnotation;
...
public class MapperGenerator {
    ...
    public MapperGenerator(Project project, String path) {
        ...
        for (Table table: project.getTables()) {
            ...
            sourceCodeFile.packageName = project.getGroupId() + "." + project.getArtifactId() + ".mapper";
