...
public class ProjectOld {
    ...
    public static class DataAccess {
        ...
        @Transient
        private List<DataStoreOld> dataStoreOlds;
        ...
        public List<DataStoreOld> getDataStoreByCarrier(DataCarrier carrier) {
            List<DataStoreOld> stores = new ArrayList<>();
            for (DataStoreOld store: this.dataStoreOlds) {
