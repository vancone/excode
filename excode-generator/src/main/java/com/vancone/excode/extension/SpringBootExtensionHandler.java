package com.vancone.excode.extension;
...
//    }
    ...
    public ProjectOld.DataAccess.Solution.JavaSpringBoot.Extension getExtension(ProjectOld.DataAccess.Solution.JavaSpringBoot module, String id) {
        for (ProjectOld.DataAccess.Solution.JavaSpringBoot.Extension extension: module.getExtensions()) {
     ...
     * @param module
     */
    public Output crossOrigin(ProjectOld.DataAccess.Solution.JavaSpringBoot module) {
        ...
        ProjectOld.DataAccess.Solution.JavaSpringBoot.Extension extension = getExtension(module, ExtensionType.SPRING_BOOT_CROSS_ORIGIN);
     ...
     * @param outputs
     */
    public Output swagger2(ProjectOld.DataAccess.Solution.JavaSpringBoot module, ProjectOld.DataAccess dataAccess, List<Output> outputs) {
        ...
        String swaggerTags = "";
        List<DataStoreOld> stores = dataAccess.getDataStoreByCarrier(DataCarrier.MYSQL);
        ...
        for (DataStoreOld store: dataAccess.getDataStoreByCarrier(DataCarrier.MYSQL)) {
