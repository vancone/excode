...
import com.vancone.excode.service.DataStoreService;
 ...
 */
@RestController
@RequestMapping("/api/excode/data-store-old")
public class DataStoreControllerOld {
    ...
    @PostMapping
    public Response create(@RequestBody DataStoreOld store) {
        dataStoreService.save(store);
        return Response.success();
    }

    @PutMapping
    public Response update(@RequestBody DataStoreOld store) {
        dataStoreService.save(store);
        return Response.success();
    }
