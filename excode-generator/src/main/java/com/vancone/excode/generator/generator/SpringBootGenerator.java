...
public class SpringBootGenerator {
    ...
    public void addDependencyByLabel(PomFile pom, String label) {
        List<PomFile.Dependency> dependencies = mongoTemplate.find(Query.query(Criteria.where("label").is(label)), PomFile.Dependency.class);
