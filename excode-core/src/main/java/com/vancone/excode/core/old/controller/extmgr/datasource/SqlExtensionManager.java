package com.vancone.excode.core.old.controller.extmgr.datasource;
...
public class SqlExtensionManager {
    ...
    public static String createTableQueryOld(Table table) {
    ...
    public static String insertQueryOld(Table table, boolean ignorePrimaryKey) {
    ...
    public static String updateQueryOld(Table table) {
