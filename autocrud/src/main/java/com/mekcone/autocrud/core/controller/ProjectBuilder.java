...
public class ProjectBuilder {
    ...
    public void buildSpringBootProject() {
        FileManager.checkDirectory(backendSourceBaseUrl + "/com/mekcone/autocrud/core/model");
        FileManager.checkDirectory(backendSourceBaseUrl + "/mapper");
        FileManager.checkDirectory(backendSourceBaseUrl + "/com/mekcone/autocrud/core/controller");
        ...
        new ModelGenerator(ProjectLoader.project, backendSourceBaseUrl + "/com/mekcone/autocrud/core/model");
        ...
        new ControllerGenerator(ProjectLoader.project, backendSourceBaseUrl + "/com/mekcone/autocrud/core/controller");
