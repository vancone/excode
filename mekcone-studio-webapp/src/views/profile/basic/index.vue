<template>
  <page-header-wrapper>
    <a-card :bordered="false">
      <a-descriptions title="MekCone Mall Example">
        <a-descriptions-item label="Author">Tenton Lien</a-descriptions-item>
        <a-descriptions-item label="Organization">MekCone Studio Team</a-descriptions-item>
