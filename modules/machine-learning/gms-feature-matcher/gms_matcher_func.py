# opencv-python is required to run this program
import math
...
def matches(img1, img2, threshold):
    ...
    #--------------------------------------------------------------#
    # num_matches: 找到匹配点的数量，数量越多说明两张图片相似的特征越多 #
    #--------------------------------------------------------------#
    matches, num_matches = gms.compute_matches(img1, img2)
...
if __name__ == '__main__':
    ...
    flag = matches(img1, img2, 10)
    print("if it matches: {}".format(flag))
